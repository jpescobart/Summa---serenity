...
Feature: Cracion de novedades ocasionales y fijas para un colaborador registrado.
  ...
  Scenario Outline: Verificar que se permita crear varias novedades fijas especiales para un cliente en especifico
    Given  que  ingreso al portal de novedades de Summa
    When   seleccion un cliente e ingreso todos los datos para generar varias novedad fija especial con "<accion>"
