    ...
    public void seleccinarTipoAccionNovedadfijaEspecial(String contador){
        ...
        switch (contadorFinal){
            ...
            case 1: accion="Eliminaciòn";
                ...
                btnContinuar.click();
            break;
            case 2: accion="Modificaciòn Valor";
                btonAccion.click();
                ...
                break;
            case 3: accion="Modificaciòn Fecha";
                btonAccion.click();
                ...
                btnContinuar.click();
                break;
            case 4: accion="Modificaciòn Fecha y Valor";
                btonAccion.click();
                ...
                btnContinuar.click();
                break;
            case 5: accion="Modificaciòn del periodo de aplicacion";
                btonAccion.click();
